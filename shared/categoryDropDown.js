...
export default function CategoryPicker({onChangeCatgory,value}){
    ...
    return(
        ...
        <DropDownPicker
                    items={[
                        ...
                        {label: 'social protection', value: 'social protection'}, {label: 'administration and management', value: 'administration and management'}, {label: 'support for non-arabic speaking immigrant students', value: 'support for non-arabic speaking immigrant students'},
                    ]}
                    ...
                    onChangeItem={item => onChangeCatgory(item.label)}
                    placeholder={value}
