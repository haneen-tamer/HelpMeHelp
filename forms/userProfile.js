...
import GovernoratePicker from '../shared/governorateDropDownTemp';
      ...
      <View style={globalStyles.columnAlginStyle}>
        <View style={styles.imageborderStyle}>
         ...
         <View style={styles.textAlignStyle}> 
           ...
           <TextInputCard value={"assem08"} allow_pass={false} allow_multi={true}/>

           <Text style={styles.titleStyle}>Name</Text>
           <TextInputCard value={"assem"} allow_pass={false} allow_multi={true}/>

           <Text style={styles.titleStyle}>Password</Text>
           <TextInputCard value={"1111"} allow_pass={true} allow_multi={false}/>

           <Text style={styles.titleStyle}>Email Address</Text>
           <TextInputCard value={"assem@gmail.com"} allow_pass={false} allow_multi={true}/>
          ...
          <GovernoratePicker />
           ...
           <TextInputCard value={"in cairo"} allow_pass={false} allow_multi={true}/>
